        ...
        */
        ...
        PhotonPeer.prototype.resetKeepAlive = function () {
            ...
            if (this.keepAliveTimeoutMs >= 1000) {
                this.keepAliveTimer = setTimeout(function () { return _this._send({ irq: 1, vals: [1, Date.now()] }, true); }, this.keepAliveTimeoutMs);
            }
        };
...
//                     }
                     switch (document.location.protocol) {
                        case "http:":
                             this.masterServerAddress = "ws://app.exitgamescloud.com:9090";
                             this.nameServerAddress = "ws://ns.exitgames.com:9093";
                            break;
                        case "https:":
                            this.masterServerAddress = "wss://app.exitgamescloud.com:19090";
                            this.nameServerAddress = "wss://ns.exitgames.com:19093";
                            break;
                        default:
                            var s0 = "wrong_protocol_error";
